...
func TestHash(t *testing.T) {
	...
	var tests = []*struct {
		...
		},
		{
			...
			bundleHashes: []trinary.Hash{consts.NullHashTrytes},
		...
		{
			desc:         "single node",
			bundleHashes: []trinary.Hash{consts.NullHashTrytes, consts.NullHashTrytes},
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			...
			assert.Equal(t, expBytes, hasher.TreeHash(tt.bundleHashes))
		})
	}
}
